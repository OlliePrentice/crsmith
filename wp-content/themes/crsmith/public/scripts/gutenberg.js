...
"use strict";
/*!*******************************************!*\
  !*** ./assets/scripts/admin/gutenberg.js ***!
  \*******************************************/
...
wp.hooks.addFilter('blocks.registerBlockType', 'my-plugin/class-names/color-blocks', addColorPickers);
/**
...
var _wp$components = wp.components,
    ...
    RangeControl = _wp$components.RangeControl; //restrict to specific block names

var allowedBlocks = ['core/spacer'];
var MIN_MARGIN_HEIGHT = -250;
var MAX_MARGIN_HEIGHT = 250;
/**
...
var withAdvancedControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(BlockEdit, _objectSpread({}, props)), isSelected && allowedBlocks.includes(name) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(InspectorControls, {
...
function applyExtraClass(extraProps, blockType, attributes) {
  ...
  if (allowedBlocks.includes(blockType.name)) {
    return lodash.assign(extraProps, {
      style: _objectSpread(_objectSpread({}, extraProps.style), {}, {
        marginTop: marginTop,
